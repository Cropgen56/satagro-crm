...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-30 flex h-screen w-[260px] flex-col border-r border-gray-200 bg-white">
      <div className="flex h-[84px] shrink-0 items-center justify-center border-b border-gray-100 px-4">
        <Logo size="sidebar" className="h-20 max-w-[210px] object-center" />
      </div>
      ...
      <div className="border-t border-gray-100 p-4">
        <button
          ...
          className="flex w-full cursor-pointer items-center gap-3 rounded-xl p-2 transition hover:bg-gray-50"
        >
        ...
        <button
          ...
          className="mt-2 flex w-full cursor-pointer items-center gap-2 rounded-lg px-3 py-2 text-sm text-gray-500 transition hover:bg-gray-50 hover:text-gray-800"
        >
