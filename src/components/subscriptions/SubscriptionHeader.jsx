...
export default function SubscriptionHeader() {
  ...
  return (
    <header className="mb-6 flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
      <div>
        <h1 className="text-2xl font-bold text-brand-primary lg:text-[28px]">Subscriptions</h1>
        <p className="mt-1 text-sm text-gray-500">Manage farmer plans, renewals, and subscription lifecycle</p>
      </div>
